...
public class VueGenerale extends JFrame implements ActionListener {
    ...
    private void afficherPanel(int choix) {
        ...
        switch (choix) {
            ...
            case 4: unPanelLogements.setVisible(true); break;
            case 5:
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        switch (choix) {
            ...
            case "Propriétaires": this.afficherPanel(2); break;
            case "Réservations": this.afficherPanel(3); break;
            case "Logements": this.afficherPanel(4); break;
            case "Stats": this.afficherPanel(5); break;
        }
    }
